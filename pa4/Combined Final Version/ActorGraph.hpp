 ...
 * Description: union two upTrees
 */
  void unionNodes(Actor* actorA, Actor* actorB);

/*
 * Function name: cleanParent
 * Description: reset parent actor of all the actors
 */
  void cleanParent();
