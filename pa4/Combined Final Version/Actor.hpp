 ...
 * Description: update a root's size
 */
 ...
 * Description: get size of the upTree
 * Return Value: the size of the upTree stored in the root actor
 */
 ...
 * Return Value: the parent of upTree node
 */
